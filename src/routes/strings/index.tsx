...
const toolIcons = {
  ...
  'sort-lines': TbOutlineArrowsSort,
  'find-replace': TbOutlineReplace,
  escape: TbOutlineCode,
  reverse: TbOutlineFlipHorizontal,
  diff: TbOutlineFileDiff,
}
