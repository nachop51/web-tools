...
import {
  TbOutlineCalendar,
  TbOutlineHourglass,
  TbOutlineCalendarRepeat,
  TbOutlineCalendarStats,
...
const toolIcons = {
  unix: TbOutlineCalendar,
  duration: TbOutlineHourglass,
  cron: TbOutlineCalendarRepeat,
  'date-diff': TbOutlineCalendarStats,
  'date-add': TbOutlineCalendarPlus,
}

export default function DatetimeIndex() {
  const category = categoryById('datetime')!
  const tools = toolsByCategory('datetime')
