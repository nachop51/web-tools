...
export function fractionOp(a: Fraction, op: FractionOp, b: Fraction): FractionResult {
  let result: Fraction;
  switch (op) {
    case "add":      result = { num: a.num * b.den + b.num * a.den, den: a.den * b.den }; break;
    case "subtract": result = { num: a.num * b.den - b.num * a.den, den: a.den * b.den }; break;
    case "multiply": result = { num: a.num * b.num, den: a.den * b.den }; break;
    case "divide":   result = { num: a.num * b.den, den: a.den * b.num }; break;
  }
