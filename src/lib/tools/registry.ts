...
export const tools: Tool[] = [
  // Numbers
  {
    ...
    name: 'Base converter',
    description:
      "Live conversion between binary, octal, decimal, and hexadecimal — with two's complement at fixed bit widths, custom bases up to 36, and an IEEE-754 inspector.",
