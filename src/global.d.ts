...
declare module 'culori' {
  ...
  export function converter(mode: string): (color: Color | string | undefined) => Color | undefined
  ...
  export function wcagContrast(a: Color | string | undefined, b: Color | string | undefined): number
...
declare module 'apca-w3' {
  ...
  export function calcAPCAcustom(text: number[], bg: number[], config?: Record<string, unknown>): number
}
